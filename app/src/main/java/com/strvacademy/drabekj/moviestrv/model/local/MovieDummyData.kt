...
class MovieDummyData: MovieLocalDataSource {
	...
	val actorArray: Array<Actor> = arrayOf(
			Actor(1, "John Dow", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(2, "Emma Watson", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(3, "Emilia Clarke", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(4, "Andy Serkis", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(5, "Henry Cavill", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(6, "Dwayne Johnson", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2")),
			Actor(7, "Kevin Hart", "1.1.1970", arrayOf("Catch me if you can", "Movie 1", "Movie 2"))
	)
